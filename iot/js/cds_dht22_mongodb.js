...
// MongoDB connection
mongoose.connect('mongodb://localhost:27017/iot99'); // DB name
...
sp.on('data', function (data) { // call back when data is received
    ...
    if (readData.lastIndexOf(',') > firstcommaidx && firstcommaidx > 0) {
        temp = readData.substring(secondcommaidx + 1, readData.indexOf(',',secondcommaidx+1));
        humi = readData.substring(readData.indexOf(',',secondcommaidx+1) + 1, readData.lastIndexOf(','));
